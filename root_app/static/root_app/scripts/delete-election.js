...
$('.delete-election').click(function(){

    let election_id = $(this).parents('td').children('input[type=hidden]').val()
    ...
    $.ajax({
        ...
        success: function(response){
            if(response.code == 200){
                ...
                $('#election'+election_id).fadeOut('slow').empty()
            }
            else{
                swal(
                    "Unsuccess !!",
